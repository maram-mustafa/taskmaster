...
public class TaskItemFragment extends Fragment {
    ...
    private static final String ARG_PARAM1 = "title";  // add parameter
    ...
    public static TaskItemFragment newInstance(String mTitle, String mBody, String mState) {   // factory method which static method thats return an object type of the class lives inside
